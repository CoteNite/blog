...
写成中还存在上下文，上下文我们并不难理解是什么，Spring中有SpringApplicationContext，Android有Context，他们都是用来完成资源的获取与配置功能
...
其重点EmptyCoroutineContext是Kotlin自己为我们提供的一种上下文，就是空上下文，我们也可以自己