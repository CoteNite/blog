...
一个具体的实践是，在DDD中，Domain层往往会使用Repository层提供的获取Domain实体的功能，但是Domain层往往不会依赖于真正的Repository实现类，而是在Domain中实现一个Repository接口，然后定义好自己要使用的方法的返回值和入参，然后让Repository自己对齐