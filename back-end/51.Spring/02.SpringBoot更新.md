...
class HelloWorldController {  
    ...
    @GetMapping("/hello", version = "1", produces = [MediaType.TEXT_PLAIN_VALUE])  
    fun hello(): String {  
        return "Hello World!"  
    }  
  
    @GetMapping("/hello", version = "2",produces = [MediaType.TEXT_PLAIN_VALUE])  
    fun hello2(): String {  
        return "Hello World2!"  
    }  
...
我们现在可以写出与之类似的代码，其默认映射出的API分别是

- `/api/v1/hello`
- `/api/v2/hello`

我们也可以通过修改配置文件的方式来更改不同的版本控制规则
